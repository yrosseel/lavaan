ctr_pml_plrt <- function(lavobject = NULL, lavmodel = NULL, lavdata = NULL,
    ...
    H0.Hessian <- lav_model_hessian(lavmodel       = lavmodel,
                                    lavsamplestats = lavsamplestats,
                                    lavdata        = lavdata,
                                    lavcache       = lavcache,
                                    estimator      = "PML",
...
VCOV <- lav_model_vcov(lavmodel       = fittedSat2@Model,
                       lavsamplestats = fittedSat2@SampleStats,
                       lavoptions     = fittedSat2@Options,
...
list(PLRTH0Sat = PLRTH0Sat, stat = FSA_PLRT_SEM, df = adjusted_df, p.value = pvalue)
}
############################################################################
