  ...
  if (n_block_flat > 0L) {
    ...
    for (block in seq_len(nblocks)) {
      ...
      list_block <- lav_pt_flat(flat_block,
        ...
        std_lv = std_lv, correlation = correlation,
        correlation_delta_free = correlation_delta_free,
        composites = composites,
        composites_cov_free = composites_cov_free,
...
lavParTable <- lav_alias("lavaanify")